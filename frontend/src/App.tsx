...
const CouponCode = lazy(() => import("./pages/admin/apps/coupon"));
const Coupon = lazy( ()=> import("./pages/admin/management/couponmanagement"))
...
>
  ...
  {/* Apps */}
  <Route path="/admin/app/coupon" element={<CouponCode />} />
